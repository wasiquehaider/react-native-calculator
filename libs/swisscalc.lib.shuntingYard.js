...
global.swisscalc.lib.shuntingYard.prototype.addNullaryOperator = function(
  operator
) {
  this.applyOperator(operator);
};
...
// Evaluates the NullaryOperator and pushes result to stack.
global.swisscalc.lib.shuntingYard.prototype.addUnaryOperator = function(
  operator
) {
  this.applyOperator(operator);
};
...
global.swisscalc.lib.shuntingYard.prototype.addBinaryOperator = function(
  operator
) {
