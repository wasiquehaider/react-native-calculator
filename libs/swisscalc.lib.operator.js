...
global.swisscalc.lib.operator = function(
  arity,
  associativity,
  precedence,
  numOperands,
...
global.swisscalc.lib.operator.prototype.isHigherPrecedence = function(
  operator
) {
  if (this.Precedence == operator.Precedence)
    return (
      this.Associativity == global.swisscalc.lib.operator.ASSOCIATIVITY_LEFT
    );
