...
global.swisscalc.display.fixedPointDisplay = function(
  numDecimalPlaces,
  maxLength
) {
  this._display = "";
  this._isNegative = false;
  this._numDecimalPlaces =
    typeof numDecimalPlaces === "undefined" ? 2 : numDecimalPlaces;
...
global.swisscalc.display.fixedPointDisplay.prototype.addDigit = function(
  digit
) {
...
global.swisscalc.display.fixedPointDisplay.prototype.backspace = function() {
  ...
  if (len == 1) this._display = "";
  else if (len == 2 && this._display.charAt(0) == "-") this._display = "";
